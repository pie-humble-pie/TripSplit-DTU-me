...
import com.vrishankgupta.chatting.util.CardListAdapter;
import com.vrishankgupta.chatting.util.DataAttributes;
import com.vrishankgupta.chatting.util.Storage;
...
public class SavedAadhaarCardActivity extends AppCompatActivity {
    ...
    public void showHome(View view){
        // intent for AadharHomeActivity
        Intent intent = new Intent(this,AadharHomeActivity.class);
        // Start Activity
